...
public class AppointmentService {
	...
	public String appointment(Appointment appointment) throws InvalidInputException {
		...
		Appointment oldAppointment = appointmentRepository.findByDoctorIdAndTimeSlotAndAppointmentDate(
		...
		if (oldAppointment != null) {
			...
			appointmentId = newAppoinment.getAppointmentId();
		}
	...
	public List<Appointment> getAppointmentsForUser(String userId) {
		return Optional.ofNullable(appointmentRepository.findByUserId(userId)).orElseThrow(ResourceUnAvailableException::new);
	}


	public Appointment getAppointments(String id) {

		return  appointmentRepository.findById(id).orElseThrow(ResourceUnAvailableException::new);
	}
}
